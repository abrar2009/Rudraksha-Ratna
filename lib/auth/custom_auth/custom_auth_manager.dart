...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    rudrakshaCartAuthUserSubject.add(
      RudrakshaCartAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<RudrakshaCartAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  RudrakshaCartAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = RudrakshaCartAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    rudrakshaCartAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
RudrakshaCartAuthUser? currentUser;
