                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FilterForRudrakshaBeadSize(
                                width: double.infinity,
                                height: 110,
                                rangestart: widget.minprice?.toString(),
                                rangeend: widget.maxprice?.toString(),
                                minValue: widget.minprice,
                                maxValue: widget.maxprice,
                                divisions: 10,
                                labelStart: 'mm',
                              ...
                              children: [
                                Container(
                                  ...
                                  child: FilterForYantrasPrice(
                                    width: double.infinity,
                                    height: 110,
                                    rangestart: FFAppState().YantraMinPrice ==
                                        null ||
                                        FFAppState().YantraMinPrice == ''
                                        ? widget.minprice?.toString()
                                        : FFAppState().YantraMinPrice,
                                    rangeend: FFAppState().YantraMaxPrice ==
                                        null ||
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    _model.yantraDropDownValueController ??=
                                        FormFieldController<String>(
                                          _model
                                              .yantraDropDownValue ??= FFAppState()
                                              .YantrasDeityPurpose !=
                                              null &&
                                              FFAppState()
                                                  .YantrasDeityPurpose !=
                            ...
                            Column(
                              ...
                              children: [
                                Container(
                                  width: double.infinity,
                                  height: 110,
                                  child: custom_widgets.FilterForGemstone(
                                    width: double.infinity,
                                    height: 100,
                                  ),
                                ),
