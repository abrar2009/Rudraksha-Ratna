...
class FilterForGemstone extends StatefulWidget {
  const FilterForGemstone({
    super.key,
    this.width,
    this.height,
    this.rangestart,
  ...
  @override
  State<FilterForGemstone> createState() => _FilterForGemstoneState();
}

class _FilterForGemstoneState extends State<FilterForGemstone> {
              ...
              onChanged: (RangeValues values) {
                ...
                FFAppState().update(
                  () {
                    ...
                    print(FFAppState().rangestartString);
                    FFAppState().rangeendString =
                        _currentRangeValues.end.toString();
                    print(FFAppState().rangeendString);
                  },
                );
              },
            ),
