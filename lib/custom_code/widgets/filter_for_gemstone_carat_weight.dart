...
class FilterForGemstoneCaratWeight extends StatefulWidget {
  const FilterForGemstoneCaratWeight({
    super.key,
    this.width,
    this.height,
    this.rangestart,
  ...
  @override
  State<FilterForGemstoneCaratWeight> createState() =>
      _FilterForGemstoneCaratWeightState();
}

class _FilterForGemstoneCaratWeightState
    extends State<FilterForGemstoneCaratWeight> {
        ...
        children: [
          ...
          SliderTheme(
            ...
            child: RangeSlider(
              ...
              labels: RangeLabels(
                'Weight ${_currentRangeValues.start.round()}ct',
                'Weight ${_currentRangeValues.end.round()}ct',
              ),
          ...
          Row(
            ...
            children: [
              Text('Weight ${widget.minValue!}ct',
                  style: FlutterFlowTheme.of(context).bodyMedium),
              Text('Weight ${widget.maxValue!}ct',
                  style: FlutterFlowTheme.of(context).bodyMedium),
            ],
          ),
        ],
