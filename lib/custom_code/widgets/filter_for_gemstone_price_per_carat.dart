...
class FilterForGemstonePricePerCarat extends StatefulWidget {
  const FilterForGemstonePricePerCarat({
    super.key,
    this.width,
    this.height,
    this.rangestart,
  ...
  @override
  State<FilterForGemstonePricePerCarat> createState() =>
      _FilterForGemstonePricePerCaratState();
}

class _FilterForGemstonePricePerCaratState
    extends State<FilterForGemstonePricePerCarat> {
        ...
        children: [
          ...
          SliderTheme(
            ...
            child: RangeSlider(
              ...
              labels: RangeLabels(
                'INR ${_currentRangeValues.start.round()}/ct',
                'INR ${_currentRangeValues.end.round()}/ct',
              ),
          ...
          Row(
            ...
            children: [
              Text('INR ${widget.minValue!}/ct',
                  style: FlutterFlowTheme.of(context).bodyMedium),
              Text('INR ${widget.maxValue!}/ct',
                  style: FlutterFlowTheme.of(context).bodyMedium),
            ],
          ),
        ],
