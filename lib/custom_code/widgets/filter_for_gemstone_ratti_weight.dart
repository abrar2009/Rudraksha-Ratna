...
class FilterForGemstoneRattiWeight extends StatefulWidget {
  const FilterForGemstoneRattiWeight({
    super.key,
    this.width,
    this.height,
    this.rangestart,
  ...
  @override
  State<FilterForGemstoneRattiWeight> createState() =>
      _FilterForGemstoneRattiWeightState();
}

class _FilterForGemstoneRattiWeightState
    extends State<FilterForGemstoneRattiWeight> {
        ...
        children: [
          ...
          SliderTheme(
            ...
            child: RangeSlider(
              ...
              labels: RangeLabels(
                'Weight ${_currentRangeValues.start.round()}ratti',
                'Weight ${_currentRangeValues.end.round()}ratti',
              ),
          ...
          Row(
            ...
            children: [
              Text('Weight ${widget.minValue!}ratti',
                  style: FlutterFlowTheme.of(context).bodyMedium),
              Text('Weight ${widget.maxValue!}ratti',
                  style: FlutterFlowTheme.of(context).bodyMedium),
            ],
          ),
        ],
