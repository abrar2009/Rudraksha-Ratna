...
class FilterForYantrasPrice extends StatefulWidget {
  const FilterForYantrasPrice({
    super.key,
    this.width,
    this.height,
    this.rangestart,
  ...
  @override
  State<FilterForYantrasPrice> createState() => _FilterForYantrasPriceState();
}

class _FilterForYantrasPriceState extends State<FilterForYantrasPrice> {
  @override
