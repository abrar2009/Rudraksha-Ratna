            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        FlutterFlowChoiceChips(
                          options: [
                            ChipData(
                                'Last 30 Days', FontAwesomeIcons.windowClose)
                          ],
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 16.0, 0.0, 12),
                    child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/container_(1).png',
                                width: 48.0,
                                height: 58.0,
                                fit: BoxFit.cover,
                              ),
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Builder(
                        builder: (context) {
                          ...
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children: List.generate(orderList.length, (orderListIndex) {
                        ...
                        builder: (context) {
                          ...
                          return Column(
                            ...
                            children: List.generate(orderList.length, (orderListIndex) {
                              ...
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(productList.length, (productListIndex) {
