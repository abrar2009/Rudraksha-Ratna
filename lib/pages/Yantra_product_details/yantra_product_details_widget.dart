...
class YantraProductDetailsWidget extends StatefulWidget {
  const YantraProductDetailsWidget({
    ...
    required this.cartId,
        ...
        this.producttype =
            producttype ?? 'yantras/web-yantraproduct-detail?yantraproduct';
  ...
  @override
  State<YantraProductDetailsWidget> createState() =>
      _YantraProductDetailsWidgetState();
}

class _YantraProductDetailsWidgetState
    extends State<YantraProductDetailsWidget> {
  ...
  Future<void> fetchCartData() async {
    ...
    try {
      ...
      if (cartItem != null) {
        String? newSelectedVariation =
            getJsonField(cartItem, r'''$.product_variation_name''').toString();
        String? newPreSelectedDesign =
            getJsonField(cartItem, r'''$.design_name''').toString();
        String? newProductVariationID =
            getJsonField(cartItem, r'''$.product_variation_id''').toString();
        String? newDesignGroupID =
            getJsonField(cartItem, r'''$.id''').toString();
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          ...
                                          _scrollController.animateTo(
                                              _YantraProductDetailsWidgetratingKey
                                                  .currentContext!
                                                  .findRenderObject()!
                                                  .getTransformTo(null)
                                                  .getTranslation()
                                          ...
                                          child: ExpandablePanel(
                                            ...
                                            expanded: Builder(
                                              builder: (context) {
                                                ...
                                                print(
                                                    'Product Variants: $productVariants'); // Debug: Check all product variants
                                                print(
                                                    '_model.id: ${productVariationID} (type: ${productVariationID.runtimeType})'); // Debug: Check the model ID type
                                                ...
                                                final selectedProduct =
                                                  ...
                                                  (product) =>
                                                      ...
                                                      productVariationID,
                                                  orElse: () =>
                                                      null, // Handle case where no product is found
                                                );
                                                ...
                                                final designGroup =
                                                    selectedProduct[
                                                        ...
                                                        [];
                                                print(
                                                    'Design Group: $designGroup'); // Debug: Check the design group list

                                                // Assuming designGroupID is available in your widget
                                                final String? designGroupID =
                                                    productVariationID; // Replace with your logic to get the designGroupID
                                                      ...
                                                      return InkWell(
                                                        ...
                                                        onTap: () {
                                                          ...
                                                          setState(() {
                                                            ...
                                                            _model.designprice =
                                                                designItem[
                                                                    'price']; // Update design price based on selected design
                                                          ...
                                                          decoration:
                                                            ...
                                                            border: Border.all(
                                                              color: (designItem[
                                                                          ...
                                                                          index ||
                                                                      preSelectedDesign ==
                                                                          getJsonField(designItem, r'''$.name''')
                                                                              .toString())
                                                                  ? const Color(
                                                                      0xFF740074)
                                                                  : FlutterFlowTheme.of(
                                                ...
                                                children: [
                                                  TextSpan(
                                                    text:
                                                      ...
                                                      functions.currencyConversion(
                                                          FFAppState().currencyRate,
                                                          ((OtherProductsDetailsCall.yantravariantdatasellingprice(
                                                                        containerOtherProductsDetailsResponse
                                                                            ?.jsonBody,
                                                                      )![_model.selectedCertificationindex!] +
                                                                      (_model.designprice!) +
                                                    ...
                                                    text: '${valueOrDefault<String>(FFAppState().currencyName, 'INR')} ${formatNumber(
                                                          functions
                                                              .currencyConversion(
                                                                  FFAppState()
                                                                      .currencyRate,
                                                                  ((functions.stringtoIntFunction(OtherProductsDetailsCall
                                                                              .yantraProductsellingprice(
                                                                            containerOtherProductsDetailsResponse?.jsonBody,
                                                                          ))!) +
                                                                          (_model
                                                                              .energizationprice!))
                                            ...
                                            children: [
                                                                  ...
                                                                  text:
                                                                    ...
                                                                    children: [
                                                                      TextSpan(
                                                                        text: valueOrDefault<
                                                                            String>(
                                                                          (OtherProductsDetailsCall.reviewdata(containerOtherProductsDetailsResponse?.jsonBody) as List)
                                                                              .length
                                                                              .toString(),
                                                                          '0',
                                                                        ),
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  print(
                                                      "productMainType:${OtherProductsDetailsCall.productMainType(
                                                    containerOtherProductsDetailsResponse
                                                        ?.jsonBody,
                                                  )?.toString()}");
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  valueOrDefault<String>(
                                                    OtherProductsDetailsCall
                                                        .Otherproductreviewcustomercomment(
                                                      containerOtherProductsDetailsResponse
                                                          ?.jsonBody,
                                                    ),
                                                    'x',
                                                ...
                                                Row(
                                                  children: [
                                                    Text(
                                                      valueOrDefault<String>(
                                                        OtherProductsDetailsCall
                                                            .Otherproductreviewcustomername(
                                                          containerOtherProductsDetailsResponse
                                                              ?.jsonBody,
                                                        ),
                                                        'x',
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(16, 16, 0, 30),
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final relatedProduct =
                                            OtherProductsDetailsCall
                                                    .yantraProductsimilarcategoryproduct(
                                                  containerOtherProductsDetailsResponse
                                                      ?.jsonBody,
                                                )?.toList() ??
                                                [];
                                        ...
                                        relatedProduct.sort((a, b) {
                                          ...
                                          if (getJsonField(a, r'''$.reserved''')
                                                      .toString() ==
                                                  'true' &&
                                              getJsonField(b, r'''$.reserved''')
                                                      .toString() ==
                                                  'false') {
                                            return -1;
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            if (currentAuthenticationToken != null &&
                              ...
                              setState(() {
                                _isLoading =
                                    true; // Set loading state to true when API call starts
                              });
                              ...
                              if (OtherProductsDetailsCall.productVariantStatus(
                                ...
                                result =
                                    await OtherSinglePriceAddToCartCall.call(
                                  hosturl: FFAppConstants.sanityurl,
                                  token: currentAuthenticationToken,
                                  productid: OtherProductsDetailsCall.productid(
                                    containerOtherProductsDetailsResponse
                              ...
                              setState(() {
                                _isLoading =
                                    false; // Set loading state to false when API call completes
                              });
                              ...
                              if ((result?.succeeded ?? false)) {
                                ...
                                setState(() {});
                                if (getJsonField(result?.jsonBody ?? '',
                                            r'''$.status''')
                                        .toString() !=
                                    "failed") {
                                  await showModalBottomSheet(
                          ...
                          showLoadingIndicator:
                              _isLoading, // Show loading indicator based on the state
                        ),
                        FFButtonWidget(
                          onPressed: () async {
                            if (currentAuthenticationToken != null &&
                              ...
                              FFAppState().productvariationId =
                                  OtherProductsDetailsCall.productVariantDataId(
                                containerOtherProductsDetailsResponse?.jsonBody,
                              )?[_model.selectedVariatoinindex!];
                                        ...
                                        if (selectVariation.isNotEmpty &&
                                          ...
                                          _model.selectedCertification =
                                              getJsonField(selectVariation[0],
                                                  ...
                                                  .toString();
                                          _model.selectedCertificationindex =
                                              0; // Set the index to the first variation

                                          print(
                                              '_model.selectedVariatoinindex: ${_model.selectedVariatoinindex}');
                                        }
                                            ...
                                            expanded: Builder(
                                              builder: (context) {
                                                ...
                                                print(
                                                    'Product Variants: $productVariants'); // Debug: Check all product variants
                                                print(
                                                    '_model.id: ${_model.id} (type: ${_model.id.runtimeType})'); // Debug: Check the model ID type
                                                ...
                                                if (selectedProduct == null) {
                                                  print(
                                                      'No product found for id: ${_model.id}'); // Debug: Product not found
                                                  return Text(
                                                      'No product found.'); // Return an appropriate widget when product is not found
                                                }

                                                print(
                                                    'Selected Product: $selectedProduct'); // Debug: Show selected product details
                                                  ...
                                                  TextSpan(
                                                    text: /*((functions.stringtoIntFunction(OtherProductsDetailsCall.otherProductsellingprice(
                                                        ...
                                                        '${valueOrDefault<String>(FFAppState().currencyName, 'INR')} ${formatNumber(
                                                              functions.currencyConversion(
                                                                  FFAppState().currencyRate,
                                                                  ((functions.stringtoIntFunction(OtherProductsDetailsCall.yantraProductsellingprice(
                                                                            containerOtherProductsDetailsResponse?.jsonBody,
                                                                          ))!) +
                                                                          (_model.energizationprice!))
                                                                      .toString()),
