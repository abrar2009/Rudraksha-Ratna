                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            _model.selectedBillingContainer =
                                                !_model
                                                    .selectedBillingContainer;
                                            ...
                                            _model.billingCity = getJsonField(
                                              addressDetailsItem,
                                              r'''$.cityname''',
                                            ).toString();
                                            _model.billingState = getJsonField(
                                              addressDetailsItem,
                                              r'''$.statename''',
                                            ).toString();
                                            ...
                                            _model.emailAddress = getJsonField(
                                              addressDetailsItem,
                                              r'''$.email''',
                                            ).toString();
                                            ...
                                            _model.selectedBillingVariable =
                                                !_model.selectedBillingVariable;
                                            ...
                                            print(
                                                'Billing FFAppState().billingAddressID: ${FFAppState().billingAddressID}');
                                            print(
                                                'Billing FFAppState().billingAddress1: ${FFAppState().billingAddress1}');
                                            print(
                                                'Billing FFAppState().billingCity: ${FFAppState().billingCity}');
                                            print(
                                                'Billing FFAppState().billingState: ${FFAppState().billingState}');
                                            print(
                                                'Billing FFAppState().billingPincode: ${FFAppState().billingPincode}');
                                            print(
                                                '----------------------------------------');
                                            print(
                                                'Billing Address: ${_model.billingId}');
                                            print(
                                                'Billing billingAddress1: ${_model.billingAddress1}');
                                            print(
                                                'Billing billingAddress2: ${_model.billingAddress2}');
                                            print(
                                                'Billing billingCity: ${_model.billingCity}');
                                            print(
                                                'Billing billingState: ${_model.billingState}');
                                            setState(() {});
                                            //if (_model.selectedContainer) {
                                            if (_model
                                                .selectedBillingContainer) {
                                              _model
                                                  .insertAtIndexInSelectedAddress(
                                                      0, addressDetailsIndex);
                                              setState(() {});
                                            } else {
                                              _model
                                                  .removeAtIndexFromSelectedAddress(
                                                      0);
                                              setState(() {});
                                            }
                                            setState(() {});
                ...
                child: FFButtonWidget(
                  onPressed: _model.selectedAddress.isEmpty
                      ? () {
                          ...
                          print(
                              'Billing Address: ${FFAppState().billingAddress1}');
                        }
                      : () async {
