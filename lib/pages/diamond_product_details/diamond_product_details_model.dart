...
import 'diamond_product_details_widget.dart' show DiamondProductDetailsWidget;
...
class DiamondProductDetailsModel
    extends FlutterFlowModel<DiamondProductDetailsWidget> {
  ///  Local state fields for this page.

  bool selecteddesign = true;

  bool selectedchain = true;
  ...
  int? selecteddesigncolor;

  int? selectedchaindesign;
  ...
  bool selectedChainDesign = false;

  bool productvarient = true;
  ApiCallResponse? addtoWishlist;
  ApiCallResponse? DeletetoWishlist;
