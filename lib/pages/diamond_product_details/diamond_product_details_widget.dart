...
class DiamondProductDetailsWidget extends StatefulWidget {
  ...
  @override
  State<DiamondProductDetailsWidget> createState() => _DiamondProductDetailsWidgetState();
}

class _DiamondProductDetailsWidgetState extends State<DiamondProductDetailsWidget> {
  late DiamondProductDetailsModel _model;
  final ScrollController _scrollController = ScrollController();
  final GlobalKey _DiamondProductDetailsWidgetratingKey = GlobalKey();
  final DeliveryAddressWidgetscaffoldKeyscaffoldKey = GlobalKey<ScaffoldState>();
  ...
  Future<void> fetchCartData() async {
    ...
    try {
      ...
      if (cartItem != null) {
        String? newEnergizationName = getJsonField(cartItem, r'''$.energization_name''').toString();
        String? newCertificationName = getJsonField(cartItem, r'''$.certification_name''').toString();
        String? newSelectDesignType = getJsonField(cartItem, r'''$.design_type''').toString();
        String? newMetalType = getJsonField(cartItem, r'''$.metal_id''').toString();
        String? newSelectDesignsMetalDep = getJsonField(cartItem, r'''$.design_name''').toString();
        String? newSelectDesignsChainDep = getJsonField(cartItem, r'''$.chain_name''').toString();
        String? newSelectedWristSize = getJsonField(cartItem, r'''$.wrist_size''').toString();
        String? newSelectedRingSizeSystem = getJsonField(cartItem, r'''$.ring_size_system''').toString();
        String? newSelectedRingSize = getJsonField(cartItem, r'''$.ring_size''').toString();
        int? newSelectedDesignPrice = getJsonField(cartItem, r'''$.design_price''').toInt();
        int? newSelectedChainPrice = getJsonField(cartItem, r'''$.chain_price''').toInt();
        int? newSelectedEnergizationPrice = getJsonField(cartItem, r'''$.energization_price''').toInt();
        int? newSelectedCertificationPrice = getJsonField(cartItem, r'''$.certification_price''').toInt();
  ...
  void _triggerMetalDependentDesignApi() {
    ...
    metalDependantDesign.call(
      ...
      final metalData = getJsonField(response.jsonBody, r'''$.data''', true) ?? [];
  ...
  void didChangeDependencies() {
    ...
    selectedOptions = ModalRoute.of(context)?.settings.arguments as SelectedOptions?;
  ...
  void _initializeSelectedIndices() {
    ...
    final List<dynamic> energizationList = OtherProductsDetailsCall.pujaenergizationlist(
      containerOtherProductsDetailsResponse?.jsonBody,
    )?.toList() ?? [];

    _model.selectedEnergizationIndex = energizationList.indexWhere((item) =>
    getJsonField(item, r'''$.name''').toString() == _model.selectedEnergization);
                ...
                children: [
                  ...
                  FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final jsonResponse = containerOtherProductsDetailsResponse?.jsonBody;

                      // Determine group id based on choice chip selection
                      if (_model.choiceChipsValue1 == 'Pendant' || _model.choiceChipsValue2 == 'Pendant' || selectDesignType == 'Pendant') {
                        groupId = getJsonField(jsonResponse, r'''$.data.pendent[0]''') as int? ?? 0;
                        designType = 2;
                      } else if (_model.choiceChipsValue1 == 'Bracelet' || _model.choiceChipsValue2 == 'Bracelet' || selectDesignType == 'Bracelet') {
                        groupId = getJsonField(jsonResponse, r'''$.data.bracelet[0]''') as int? ?? 0;
                        designType = 1;
                      } else if (_model.choiceChipsValue1 == 'Ring' || _model.choiceChipsValue2 == 'Ring' || selectDesignType == 'Ring') {
                        groupId = getJsonField(jsonResponse, r'''$.data.ring[0]''') as int? ?? 0;
                        designType = 3;
                      }
                      ...
                      print('_model.selectedGroupId = groupId; ${_model.selectedGroupId}');
                      print('_model.selectedDesignType = designType; ${_model.selectedDesignType}');

                      final decodedDescription = utf8.decode(description.codeUnits);

                      if (kDebugMode) {
                        print("data87: ${getJsonField(
                            containerOtherProductsDetailsResponse?.jsonBody,
                            r'''$.data''').toString()}");
                      }
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                            ...
                                            children: [
                                              ...
                                              TextSpan(
                                                text: valueOrDefault<String>(
                                                  OtherProductsDetailsCall.productcode(
                                                    containerOtherProductsDetailsResponse?.jsonBody,),
                                                  'Code',
                                                ),
                                        ...
                                        if(OtherProductsDetailsCall.reviewdata(containerOtherProductsDetailsResponse?.jsonBody) != null)
                                          Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                              GestureDetector(
                                                onTap: () {
                                                  ...
                                                  _scrollController.animateTo(
                                                    _DiamondProductDetailsWidgetratingKey.currentContext!
                                                        .findRenderObject()!
                                                        .getTransformTo(null)
                                                        .getTranslation()
                                                        .y,
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Builder(
                                            builder: (context) {
                                              final selectVariation = OtherProductsDetailsCall.pujaenergizationlist(
                                                containerOtherProductsDetailsResponse?.jsonBody,
                                              )?.toList() ?? [];

                                              // Set default selected energization if not already set
                                              if (_model.selectedEnergization == null && selectVariation.isNotEmpty) {
                                                _model.selectedEnergization = getJsonField(selectVariation[0], r'''$.name''').toString();
                                                _model.selectedEnergizationIndex = 0; // Set index for the first energization
                                              ...
                                              int selectedIndex = getIndexByName(selectVariation, energizationName ?? '');
                                                  ...
                                                  children: List.generate(selectVariation.length, (selectVariationIndex) {
                                                    ...
                                                    return Align(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        highlightColor: Colors.transparent,
                                                        onTap: () async {
                                                          _model.energizationprice = getJsonField(selectVariationItem, r'''$.price''');
                                                          setState(() {});
                                                          print('Energization List: $selectVariation');
                                                          print('selectedEnergizationIndex: ${_model.selectedEnergizationIndex}');
                                                          print('Energization List: $selectVariation');

                                                          selectedIndex = selectVariationIndex;
                                                          energizationName = getJsonField(selectVariationItem, r'''$.name''').toString();
                                                          _model.selectedEnergizationIndex = selectVariationIndex;
                                                          setState(() {});
                                                        },
                                                        child: Container(
                                                          height: 44,
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Center(
                                                              child: AutoSizeText(
                                                                getJsonField(selectVariationItem, r'''$.name''').toString(),
                                                                maxLines: 2,
                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                  fontFamily: 'Montserrat',
                                                                  fontSize: 13,
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Builder(
                                            builder: (context) {
                                              final selectVariation = OtherProductsDetailsCall.certificationlist(
                                                containerOtherProductsDetailsResponse?.jsonBody,
                                              )?.toList() ?? [];

                                              // Set default selected energization if not already set
                                              if (_model.selecteddesign == null && selectVariation.isNotEmpty) {
                                                _model.selectedEnergization = getJsonField(selectVariation[0], r'''$.name''').toString();
                                                _model.selectedCertificationindex = 0; // Set index for the first energization
                                                //_model.energizationprice = getJsonField(selectVariation[0], r'''$.price''');
                                              }

                                              // Get the selected index based on the current selected energization
                                              int selectedIndex = getIndexByName(selectVariation, certificationName ?? '');
                                                  ...
                                                  children: List.generate(selectVariation.length, (selectVariationIndex) {
                                                    ...
                                                    return Align(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        highlightColor: Colors.transparent,
                                                        onTap: () async {
                                                          _model.selectedcertificateprice = getJsonField(
                                                            selectVariationItem,
                                                            r'''$.price''',
                                                          );
                                                          setState(() {});
                                                          ...
                                                          selectedIndex = selectVariationIndex;
                                                          certificationName = getJsonField(selectVariationItem, r'''$.name''').toString();
                                                          _model.selectedCertificationindex = selectVariationIndex;
                                                          setState(() {});
                                                        },
                                                        child: Container(
                                      ...
                                      children: [
                                        RichText(
                                          ...
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                text: 'Select Pendant / Bracelet Design: ',
                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                  fontFamily: 'Montserrat',
                                                  fontSize: 14,
                                                  letterSpacing: 0,
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Builder(
                                                  builder: (context) {
                                                    ...
                                                    List<ChipData> chipOptions = !(OtherProductsDetailsCall.productRingData(
                                                      containerOtherProductsDetailsResponse?.jsonBody,) != null &&
                                                        (OtherProductsDetailsCall.productRingData(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          FlutterFlowChoiceChips(
                                                            ...
                                                            onChanged: (val) async {
                                                              setState(() {
                                                                selectDesignType = val?.firstOrNull; // Update selectDesignType
                                                                _model.expandableExpandableController1.expanded = true;
                                                                metalType = null;
                                                                _model.designprice = 0;
                                                                _model.selecteddesigncolor = null;
                                                                _model.selectedchaindesign = null;
                                                              });
                                                            },
                                                            selectedChipStyle: ChipStyle(
                                                              ...
                                                              iconSize: 18,
                                                              labelPadding: EdgeInsetsDirectional.fromSTEB(10, 5, 10, 5),
                                                              elevation: 0,
                                                            ...
                                                            controller: _model.choiceChipsValueController1 ??= FormFieldController<List<String>>([selectDesignType!]),
                                                            wrapped: true,
                                                          ),
                                                        ],
                                                      ),
                                  ...
                                  if (((_model.choiceChipsValue2 == 'Pendant') ||
                                      ...
                                      (_model.choiceChipsValue1 == 'Bracelet') ||
                                      (_model.choiceChipsValue2 == 'Ring') ||
                                      (_model.choiceChipsValue1 == 'Ring')) && widget.firstLevelName != 'Rudraksha' && productType != 3)
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: KeyedSubtree(
                                              key: ValueKey(_model.choiceChipsValue2), // Key changes when choice chip value changes
                                              child: FutureBuilder<ApiCallResponse>(
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  final metalDetailDropdownResponse = snapshot.data!;
                                                  print('API Response JSON Body: ${metalDetailDropdownResponse.jsonBody}');

                                                  // Parse the metal data
                                                  final metalData = (getJsonField(
                                                    metalDetailDropdownResponse.jsonBody,
                                                    r'''$.data''',
                                                    true,
                                                  ) as List<dynamic>)
                                                      .map((item) => {
                                                  ...
                                                  String? initialMetalVal = metalData.isNotEmpty ?
                                                  (metalData.firstWhere((metal) => metal['id'] == metalId, orElse: () => metalData[0])['name']) : '';

                                                  // Debugging output
                                                  print('Parsed Metal Data: $metalData');

                                                  return MetalDropdown(
                                                    items: metalData.map((e) => e['name']).toList(),
                                                    initialValue: initialMetalVal!, // Set the initial value from metalType
                                                    onChanged: (val) async {
                                                      // Find the ID for the selected metal
                                                      final selectedMetal = metalData.firstWhere((metal) => metal['name'] == val);
                                                      metalType = selectedMetal['id'];

                                                      print('metalType: $metalType');

                                                      // Fetch dependant designs based on selected metal
                                                      if (metalType != null) {
                                                        final response = await metalDependantDesign.call(
                                                          hosturl: FFAppConstants.sanityurl,
                                                          slugValue: widget.productSlugValue,
                                                          designType: _model.selectedDesignType.toString(),
                                                          metal: metalType,
                                                        ...
                                                        print('Metal Request Body: ${jsonEncode(requestBody)}');

                                                        print('Dependant Design API Response: ${response.jsonBody}');
                                                        setState(() {
                                                        ...
                                                        _model.selecteddesigncolor = null;
                                                        _model.selectedchaindesign = null;
                                                        FFAppState().selectedSizeSystem = null;
                                                        FFAppState().selectedRingSize = null;
                                                      }

                                                      setState(() {
                                                        FFAppState().selectedMetal = val; // Update selected metal
                                                      });
                                                      print('Selected Metal: ${FFAppState().selectedMetal}');
                                                    },
                                                  );
                                                },
                                              ),
                                  ...
                                  if(widget.firstLevelName == 'Rudraksha' || productType == 3)
                                    Padding(
                                            ...
                                            Container(
                                              ...
                                              child: ExpandableNotifier(
                                                ...
                                                child: ExpandablePanel(
                                                  ...
                                                  expanded: Builder(
                                                    builder: (context) {
                                                      if ((_model.choiceChipsValue2 == 'Pendant') || (_model.choiceChipsValue1 == 'Pendant')) {
                                                        return Builder(
                                                          builder: (context) {
                                                            final selectDesgn = OtherProductsDetailsCall.pendentgroup(
                                                                  containerOtherProductsDetailsResponse?.jsonBody,
                                                                )?.toList() ?? [];
                                                            return SingleChildScrollView(
                                                              scrollDirection: Axis.horizontal,
                                                              child: Row(
                                                                mainAxisSize: MainAxisSize.max,
                                                                children: List.generate(selectDesgn.length, (selectDesgnIndex) {
                                                                      ...
                                                                      return InkWell(
                                                                        ...
                                                                        onTap: () async {
                                                                          ...
                                                                          setState(() {
                                                                            ...
                                                                            selectDesignsMetalDep = getJsonField(selectDesgnItem, r'''$.name''').toString();
                                                                          });
                                                                        },
                                                                        child: Container(
                                                                          width: 114,
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: ClipRRect(
                                                                                  ...
                                                                                  child: CachedNetworkImage(
                                                                                    ...
                                                                                    imageUrl: getJsonField(selectDesgnItem,
                                                                                      r'''$.image''',
                                                                                    ).toString(),
                                                                                    width: 93,
                                                                                    //height: 120,
                                                      ...
                                                      } else if ((_model.choiceChipsValue2 == 'Bracelet') || (_model.choiceChipsValue1 == 'Bracelet')) {
                                                        return Builder(
                                                          builder: (context) {
                                                            final selectBraceletDesign = OtherProductsDetailsCall.braceletgroup(
                                                                  containerOtherProductsDetailsResponse?.jsonBody,
                                                                )?.toList() ?? [];
                                                            return SingleChildScrollView(
                                                              scrollDirection: Axis.horizontal,
                                                              child: Row(
                                                                ...
                                                                children: List.generate(
                                                                    selectBraceletDesign.length, (selectBraceletDesignIndex) {
                                                                      final selectBraceletDesignItem = selectBraceletDesign[selectBraceletDesignIndex];
                                                                      return InkWell(
                                                                        splashColor: Colors.transparent,
                                                                        focusColor: Colors.transparent,
                                                                        hoverColor: Colors.transparent,
                                                                        highlightColor: Colors.transparent,
                                                                        onTap: () async {
                                                                          print("Braclet : ${selectBraceletDesignItem}");
                                                                          _model.selecteddesign = !_model.selecteddesign;
                                                                          setState(() {});
                                                                          _model.selectedbraceletdesign = selectBraceletDesignIndex;
                                                                          _model.designprice = getJsonField(
                                                                            selectBraceletDesignItem, r'''$.price''',
                                                                          );
                                                                          _model.selecteddesignid = getJsonField(
                                                                            selectBraceletDesignItem, r'''$.id''',
                                                                          );
                                                                          setState(() {});
                                                                        },
                                                                        child: Container(
                                                                          ...
                                                                          height: 222,
                                                                          decoration: BoxDecoration(
                                                                            color: _model.selectedbraceletdesign == selectBraceletDesignIndex
                                                                                ? Color(0x26740074)
                                                                                : FlutterFlowTheme.of(context).secondaryBackground,
                                                                            borderRadius: BorderRadius.circular(5),
                                                                            border: Border.all(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: AutoSizeText(
                                                                                    getJsonField(
                                                                                      selectBraceletDesignItem, r'''$.name''',).toString(),
                                                                                    maxLines: 2,
                                                                                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: 'Montserrat',
                                                                                      fontSize: 13,
                                                      ...
                                                      } else if (_model.choiceChipsValue2 == 'Ring') {
                                                        return Builder(
                                                          builder: (context) {
                                                            final ringDesign = OtherProductsDetailsCall.productRingData(
                                                              containerOtherProductsDetailsResponse?.jsonBody,
                                                            )?.toList() ?? [];
                                                            return SingleChildScrollView(
                                                              scrollDirection: Axis.horizontal,
                                                              child: Row(
                                                                mainAxisSize: MainAxisSize.max,
                                                                children: List.generate(
                                                                    ringDesign.length, (ringDesignIndex) {
                                                                      final ringDesignItem = ringDesign[ringDesignIndex];
                                                                      return InkWell(
                                                                        splashColor: Colors.transparent,
                                                                        focusColor: Colors.transparent,
                                                                        hoverColor: Colors.transparent,
                                                                        highlightColor: Colors.transparent,
                                                                        onTap: () async {
                                                                          print("ringDesign : ${ringDesignItem}");
                                                                          _model.selectedringdesign = ringDesignIndex;
                                                                          _model.designprice = getJsonField(
                                                                            ringDesignItem, r'''$.price''',
                                                                          );
                                                                          _model.selecteddesignid = getJsonField(
                                                                            ringDesignItem, r'''$.id''',
                                                                          );
                                                                        ...
                                                                        child: Container(
                                                                          ...
                                                                          height: 222,
                                                                          decoration: BoxDecoration(
                                                                            color: _model.selectedringdesign == ringDesignIndex
                                                                                ? Color(0x26740074)
                                                                                : FlutterFlowTheme.of(context).secondaryBackground,
                                                                            borderRadius: BorderRadius.circular(5),
                                                                            border: Border.all(
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: ClipRRect(
                                                                                  ...
                                                                                  child: CachedNetworkImage(
                                                                                    ...
                                                                                    fadeOutDuration: Duration(milliseconds: 100),
                                                                                    imageUrl: getJsonField(
                                                                                      ringDesignItem, r'''$.image''',).toString(),
                                                                                    width: 100,
                                                                                    height: 120,
                                                                                    fit: BoxFit.contain,
                                                                                  ),
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: ExpandableNotifier(
                                                ...
                                                child: ExpandablePanel(
                                                  ...
                                                  expanded: Builder(
                                                    builder: (context) {
                                                      if ((_model.choiceChipsValue2 == 'Bracelet') || (_model.choiceChipsValue1 == 'Bracelet') ||
                                                          (_model.choiceChipsValue2 == 'Pendant') || (_model.choiceChipsValue1 == 'Pendant') ||
                                                          (_model.choiceChipsValue2 == 'Ring') || (selectDesignType == 'Ring')
                                                          || (selectDesignType == 'Bracelet') || (selectDesignType == 'Pendant')) {
                                                        return FutureBuilder<ApiCallResponse>(
                                                          ...
                                                          builder: (context, snapshot) {
                                                            ...
                                                            final metalDependentResponse = snapshot.data!;
                                                            print('Full API response: ${metalDependentResponse.jsonBody}');
                                                            print('Calling API with:');
                                                            print('Slug: ${widget.productSlugValue}');
                                                            print('Design Type: ${_model.selectedDesignType}');
                                                            print('Metal: $metalType');
                                                            print('Metal: $metalId');
                                                            print('Group: ${_model.selectedGroupId}');

                                                            final metalData = getJsonField(metalDependentResponse.jsonBody, r'''$.data''', true) ?? [];

                                                            print('Metal dependent data: $metalData');
                                                            ...
                                                            return SingleChildScrollView(
                                                              ...
                                                              child: Row(
                                                                mainAxisSize: MainAxisSize.max,
                                                                children: List.generate(metalData.length, (selectDesgnIndex) {
                                                                  final metalItem = metalData[selectDesgnIndex];
                                                                  return InkWell(
                                                                    splashColor: Colors.transparent,
                                                                    focusColor: Colors.transparent,
                                                                    hoverColor: Colors.transparent,
                                                                    ...
                                                                    onTap: () async {
                                                                      ...
                                                                      setState(() {
                                                                        ...
                                                                        // After selecting, update the default selected value to the current selection
                                                                        selectDesignsMetalDep = getJsonField(metalItem, r'''$.name''').toString();
                                                                      });
                                                                      ...
                                                                      setState(() {});*/
                                                                      print('_.selecteddesignid: ${_model.selecteddesignid}');
                                                                      print('selectedpendentdesign: ${_model.selecteddesigncolor}');
                                                                    },
                                                                    child: Container(
                                                                      width: 114,
                                                                      decoration: BoxDecoration(
                                            ...
                                            if (selectDesignsMetalDep != null && _model.choiceChipsValue2 != 'Ring')
                                              Divider(
                                                height: 2,
                                                thickness: 1,
                                                color: Color(0xFFE7E7E8),
                                            ...
                                            //if (_model.selecteddesigncolor != null && _model.choiceChipsValue2 != 'Ring')
                                            if (selectDesignsMetalDep != null && _model.choiceChipsValue2 != 'Ring' && selectDesignType != 'Ring')
                                              Container(
                                                decoration: BoxDecoration(),
                                                child: Column(
                                                  mainAxisSize: MainAxisSize.max,
                                                        ...
                                                        child: ExpandablePanel(
                                                          header: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              children: [
                                                                TextSpan(
                                                                  text: 'Select Chain / Thread (Optional)',
                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                    fontFamily: 'Montserrat',
                                                                    letterSpacing: 0,
                                                                    fontWeight: FontWeight.w500,
                                                            ...
                                                            builder: (context) {
                                                              return FutureBuilder<ApiCallResponse>(
                                                                ...
                                                                builder: (context, snapshot) {
                                                                  ...
                                                                  final metalDependentResponse = snapshot.data!;
                                                                  final metalData = getJsonField(metalDependentResponse.jsonBody, r'''$.chain''', true) ?? [];
                                                                  ...
                                                                  return SingleChildScrollView(
                                                                    ...
                                                                    child: Row(
                                                                      mainAxisSize: MainAxisSize.max,
                                                                      children: List.generate(metalData.length, (index) {
                                                                        final metalItem = metalData[index];
                                                                        return InkWell(
                                                                          splashColor: Colors.transparent,
                                                                          focusColor: Colors.transparent,
                                                                          hoverColor: Colors.transparent,
                                                                          ...
                                                                          onTap: () async {
                                                                            ...
                                                                            setState(() {
                                                                              _model.selectedchain = !_model.selectedchain;
                                                                              _model.chainPrice = getJsonField(
                                                                                metalItem,
                                                                                r'''$.price''',
                                                                              ).toInt();
                                                                              _model.selectedchainid = getJsonField(
                                                                                metalItem,
                                                                                r'''$.id''',
                                                                              );
                                                                              _model.selectedchaindesign = index;

                                                                              // After selecting, update the default selected value to the current selection
                                                                              selectDesignsChainDep = getJsonField(metalItem, r'''$.name''').toString();
                                                                            });

                                                                            print('_model.selectedchainid: ${_model.selectedchainid}');
                                                                            print('_model.selectedchaindesign: ${_model.selectedchaindesign}');
                                                                            print('_model.chainPrice: ${_model.chainPrice}');
                                                                            print('_model.selectedchaindesign: ${_model.selectedchaindesign}');
                                                                          },
                                                                          child: Container(
                                                                            width: 114,
                                            ...
                                            if (selectDesignsMetalDep != null && _model.choiceChipsValue2 != 'Ring' && selectDesignType != 'Ring')
                                            SizedBox(height: 4),
                                            if(selectDesignsMetalDep != null && _model.choiceChipsValue2 != 'Pendant' && selectDesignType != 'Ring' && selectDesignType != 'Pendant')
                                              Divider(
                                                height: 2,
                                                thickness: 1,
                                                color: Color(0xFFE7E7E8),
                                            ...
                                            if(selectDesignsMetalDep != null)
                                              Builder(
                                                builder: (context) {
                                                  if (_model.choiceChipsValue2 != 'Pendant' && selectDesignType != 'Pendant') {
                                                    return Padding(
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              ...
                                                              SizedBox(width: _model.choiceChipsValue2 == 'Ring' ? 16 : 10),
                                                              Expanded(
                                                                child: MetalDropdown(
                                                                  items: (_model.choiceChipsValue2 == 'Ring' || selectDesignType == 'Ring')
                                                                      ? ringsizesystem
                                                                      : wristsize,
                                                                  //initialValue: _model.choiceChipsValue2 == 'Ring' ? 'Select Ring Size System' : 'Select Wrist Size',
                                                                  initialValue: (_model.choiceChipsValue2 == 'Ring' || selectDesignType == 'Ring')
                                                                      ? selectedRingSizeSystem ?? 'Select Ring Size System'
                                                                      : (selectDesignType == 'Bracelet' && selectedWristSize != null)
                                                                      ? selectedWristSize // Display selected wrist size if available
                                                                      : 'Select Wrist Size',
                                                                  selectedValue: FFAppState().selectedSizeSystem != null && ringsizesystem.contains(FFAppState().selectedSizeSystem)
                                                                      ? FFAppState().selectedSizeSystem // Ensure selected value is valid
                                                                      : null, // Reset if invalid
                                                                  onChanged: (val) {
                                                                    setState(() {
                                                                      FFAppState().selectedRingSize = null; // Reset ring size
                                                                      FFAppState().selectedSizeSystem = val;
                                                                      print('Selected Size System: ${FFAppState().selectedSizeSystem}');
                                                                    });
                                                                  },
                                                                ),
                                                              ),
                                                          ...
                                                          if ((FFAppState().selectedSizeSystem != null || selectedRingSizeSystem != null) && FFAppState().selectedSizeSystem != 'Later / Don\'t Know'
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  SizedBox(width: 10),
                                                                  if (FFAppState().selectedSizeSystem == 'Indian Ring Size System' || selectedRingSizeSystem == 'Indian Ring Size System')
                                                                    Expanded(
                                                                      child: MetalDropdown(
                                                                        items: List.generate(indianarray.length, (index) => indianarray[index].toString()),
                                                                        initialValue: selectedRingSize ?? 'Select Ring Size',
                                                                        selectedValue: FFAppState().selectedRingSize, // Pass the current selected ring size
                                                                        onChanged: (val) {
                                                                          setState(() {
                                                                            FFAppState().selectedRingSize = val;
                                                                          });
                                                                          print('Selected Ring Size: ${FFAppState().selectedRingSize}');
                                                                        },
                                                                      ),
                                                                    ),

                                                                  if (FFAppState().selectedSizeSystem == 'US Ring Size System')
                                                                    Expanded(
                                                                      child: MetalDropdown(
                                                                        items: usarray,
                                                                        initialValue: 'Select Ring Size',
                                                                        selectedValue: FFAppState().selectedRingSize, // Pass the current selected ring size
                                                                        onChanged: (val) {
                                                                          setState(() {
                                                                            FFAppState().selectedRingSize = val;
                                                                  ...
                                                                  if (FFAppState().selectedSizeSystem == 'Inner Circumference')
                                                                    Expanded(
                                                                      child: TextFormField(
                                                                        decoration: InputDecoration(
                                                                          hintText: 'Ring size in mm',
                                                                          filled: true,
                                                                        ...
                                                                        onChanged: (val) {
                                                                          ...
                                                                          print('Entered Ring Size (mm): ${FFAppState().selectedRingSize}');
                                                                        },
                                                                      ),
                                                                    ),
                                                                ],
                                  ...
                                  if (((_model.choiceChipsValue2 == 'Pendent') ||
                                      ...
                                      (_model.choiceChipsValue1 == 'Bracelet') ||
                                      (_model.choiceChipsValue2 == 'Ring') ||
                                      (_model.choiceChipsValue1 == 'Ring')) && widget.firstLevelName != 'Rudraksha')
                                  Divider(
                                    height: 2,
                                    thickness: 1.5,
                                    color: Color(0xFFE7E7E8),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: FlutterFlowCountController(
                                            ...
                                            updateCount: (count) => setState(() => _model.countControllerValue = count),
                                            stepSize: 1,
                                            minimum: 1,
                                            maximum: 5,
                                          ),
                                                ...
                                                TextSpan(
                                                  text: '${valueOrDefault<String>(FFAppState().currencyName, 'INR')} ${formatNumber(
                                                    functions.currencyConversion(
                                                        FFAppState().currencyRate,
                                                        ((valueOrDefault<int>(
                                                          OtherProductsDetailsCall.productsellingprice(
                                                            containerOtherProductsDetailsResponse?.jsonBody,),
                                                          00000,
                                                        ) + (selectedDesignPrice!) +
                                        ...
                                        child: ExpandableNotifier(
                                          ...
                                          child: ExpandablePanel(
                                            ...
                                            theme: ExpandableThemeData(
                                              ...
                                              iconColor: FlutterFlowTheme.of(context).primaryText,
                                              iconPadding: const EdgeInsets.fromLTRB(16, 16, 14, 16),
                                            ),
                                          ),
                                        ),
                                      ),
                                                ...
                                                child: Row(
                                                  ...
                                                  children: List.generate(
                                                      relatedProduct.length,
                                                        ...
                                                        relatedProduct[
                                                        relatedProductIndex];
                                                        print("out_of_stock :${getJsonField(
                                                          relatedProductItem,
                                                          r'''$.out_of_stock''',
                                                        ).toString()}");
                                                        return InkWell(
                ...
                child: Column(
                    children: [
                      if ((OtherProductsDetailsCall.out_of_stock(
                        containerOtherProductsDetailsResponse
                            ?.jsonBody,
                      ) == false) && (OtherProductsDetailsCall.reserved(
                        containerOtherProductsDetailsResponse
                            ?.jsonBody,
                      ) == false))
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                                    ...
                                    if (widget.producttype == FFAppConstants.RudrakshaMasterProductDetailsApi) {
                                      ...
                                      _model.apiResultj7i = await AddToCartCall.call(
                                        ...
                                        productid: OtherProductsDetailsCall
                                            .rudrakshaProductid(containerOtherProductsDetailsResponse?.jsonBody,)?.toString(),
                                        ...
                                        productvariation: OtherProductsDetailsCall
                                            .productVariantStatus(containerOtherProductsDetailsResponse?.jsonBody,
                                        ),
                                        ...
                                        certification: (OtherProductsDetailsCall
                                            .certificationlistid(
                                          containerOtherProductsDetailsResponse?.jsonBody,
                                        )?[_model.selectedCertificationindex!])?.toString(),
                                        design: _model.selecteddesignid,
                                        chain: _model.selectedchainid,
                                        //ringSize: FFAppState().selectedRingSize,
                                        ringSize: FFAppState().selectedRingSize != null ? FFAppState().selectedRingSize : '',
                                        ringSizeSystem: _model.choiceChipsValue2 == 'Ring' ? FFAppState().selectedSizeSystem : '',
                                        wristSize: _model.choiceChipsValue2 == 'Bracelet' ? FFAppState().selectedSizeSystem : '',
                                      );
                                      _shouldSetState = true;
                                      ...
                                      _model.productid = OtherProductsDetailsCall
                                          .rudrakshaProductid(
                                        containerOtherProductsDetailsResponse?.jsonBody,
                                      );
                                      ...
                                      await AddToCartCall.call(
                                        ...
                                        productvariationId: 2,
                                        quantity: _model.countControllerValue?.toString(),
                                        energization: OtherProductsDetailsCall.pujaenergizationlistid(
                                          containerOtherProductsDetailsResponse?.jsonBody,
                                        )?[_model.selectedEnergizationIndex!],
                                        design: _model.selecteddesignid,
                                        chain: _model.selectedchainid,
                                      ...
                                      final requestData = {
                                        ...
                                        'chain': _model.selectedchainid,
                                        'ringSize': FFAppState().selectedRingSize,
                                        'ringSizeSystem': _model.choiceChipsValue2 == 'Ring' ? FFAppState().selectedSizeSystem : null,
                                        'wristSize': _model.choiceChipsValue2 == 'Bracelet' ? FFAppState().selectedSizeSystem : null,
                                      };
                                      _shouldSetState = true;
                                      print('Request Data JSON: ${jsonEncode(requestData)}');
                                      print('API Request Data: $requestData');
                                      print('FFAppState().selectedRingSize: ${FFAppState().selectedRingSize}');
                                      print('FFAppState().selectedSizeSystem: ${FFAppState().selectedSizeSystem}');
                                      print('FFAppState().selectedSize: ${FFAppState().selectedSize}');
                                      print('_model.selecteddesignid: ${_model.selecteddesignid}');
                                      print('_model.selectedchainidapi: ${_model.selectedchainid}');
                                      print('_model.apiResult5ep?.succeeded: ${_model.apiResult5ep?.succeeded}');
                                      print('_model.apiResult5ep?.response: ${_model.apiResult5ep?.response}');
                                      print('API Error: ${_model.apiResult5ep?.jsonBody}');
                                      print('statusCode: ${_model.apiResult5ep?.statusCode}');
                                      print('exception: ${_model.apiResult5ep?.exception}');
                                      print('exceptionMessage: ${_model.apiResult5ep?.exceptionMessage}');
                                      print('exceptionMessage: ${_model.apiResult5ep?.bodyText}');
                                      if ((_model.apiResult5ep?.succeeded ?? true))
                                      {
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(
                                            ...
                                            builder: (context) {
                                              return GestureDetector(
                                                onTap: () => _model.unfocusNode
                                                    .canRequestFocus ? FocusScope.of(context)
                                                    .requestFocus(_model.unfocusNode)
                                                    : FocusScope.of(context).unfocus(),
                                                child: Padding(
                                                  padding: MediaQuery.viewInsetsOf(context),
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  if (currentAuthenticationToken !=
                                      null && currentAuthenticationToken != '') {
                                    if (widget.producttype == FFAppConstants.RudrakshaMasterProductDetailsApi ||
                                        widget.producttype == FFAppConstants.GemstoneMasterProductDetailsApi) {
                                      FFAppState().productid = OtherProductsDetailsCall.rudrakshaProductid(
                                        containerOtherProductsDetailsResponse?.jsonBody,)!.toString();
                                      FFAppState().productvariationId = 2;
                                      FFAppState().productType = OtherProductsDetailsCall.rudrakshaMainProductType(
                                        containerOtherProductsDetailsResponse?.jsonBody,)!.toString();

                                      FFAppState().productvariation = OtherProductsDetailsCall.productVariantStatus(
                                        containerOtherProductsDetailsResponse?.jsonBody,);
                                      print(FFAppState().productvariation);

                                      FFAppState().quantity = _model.countControllerValue!.toString();
                                      FFAppState().energizationId = OtherProductsDetailsCall.pujaenergizationlistid(
                                        containerOtherProductsDetailsResponse?.jsonBody,
                                      )?[_model.selectedEnergizationIndex!];
                                      print("_model.selecteddesignid ${_model.selecteddesignid}");
                                      print("FFAppState().energizationId ${FFAppState().energizationId}");

                                      FFAppState().desingId = _model.selecteddesignid;
                                      FFAppState().selectedCertificationId = (OtherProductsDetailsCall.certificationlistid(
                                        containerOtherProductsDetailsResponse?.jsonBody,
                                      )?[_model.selectedCertificationindex!]);

                                      print("FFAppState().selectedCertificationId ${FFAppState().selectedCertificationId}");
                ...
                children: [
                  ...
                  FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // Determine group id based on choice chip selection
                      if (_model.choiceChipsValue1 == 'Pendent' || _model.choiceChipsValue2 == 'Pendent') {
                        groupId = getJsonField(jsonResponse, r'''$.data.pendent[0]''') as int? ?? 0;
                        designType = 2;
                      } else if (_model.choiceChipsValue1 == 'Bracelet' || _model.choiceChipsValue2 == 'Bracelet') {
                        groupId = getJsonField(jsonResponse, r'''$.data.bracelet[0]''') as int? ?? 0;
                        designType = 1;
                      } else if (_model.choiceChipsValue1 == 'Ring' || _model.choiceChipsValue2 == 'Ring') {
                        groupId = getJsonField(jsonResponse, r'''$.data.ring[0]''') as int? ?? 0;
                        designType = 3;
                      }
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                children: [
                                                    ...
                                                    return Align(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          ...
                                                          _model.selectedEnergizationlist = selectVariationIndex;
                                                          _model.selectedEnergization = getJsonField(selectVariationItem, r'''$.name''').toString();
                                                          _model.selectedEnergizationIndex = selectVariationIndex;
                                                          setState(() {});
                                                        },
                                                        child: Container(
                                                          height: 44,
                                                          decoration: BoxDecoration(
                                                            color: _model.selectedEnergizationlist == selectVariationIndex
                                                                ? Color(0x26740074)
                                                                : FlutterFlowTheme.of(context).secondaryBackground,
                                                            borderRadius: BorderRadius.circular(5),
                                                            border: Border.all(
                                          ...
                                          children: [
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                child: Builder(
                                                  builder: (context) {
                                                    if (!(OtherProductsDetailsCall.productRingData(
                                                      containerOtherProductsDetailsResponse?.jsonBody,) != null &&
                                                        (OtherProductsDetailsCall.productRingData(
                                                          containerOtherProductsDetailsResponse?.jsonBody,))!.isNotEmpty)) {
                                                      return FlutterFlowChoiceChips(
                                                        ...
                                                        onChanged: (val) async {
                                                          ...
                                                          setState(() {
                                                            ...
                                                            _selectedMetalId = null;  // Clear the selected metal ID
                                                            _model.designprice = 0;
                                                            _model.selecteddesigncolor = null;
                                                            _model.selectedchaindesign = null;
                                                          });
                                                        ...
                                                        initialized: _model.choiceChipsValue1 != null,
                                                        alignment: WrapAlignment.start,
                                                        controller: _model.choiceChipsValueController1 ??= FormFieldController<List<String>>(['Pendent']),
                                                        wrapped: true,
                                                      );
                                                    } else {
                                                      return SingleChildScrollView(
                                                            ...
                                                            FlutterFlowChoiceChips(
                                                              ...
                                                              onChanged: (val) async {
                                                                setState(() {
                                                                  ...
                                                                  _selectedMetalId = null;
                                                                  _model.designprice = 0;
                                                                  _model.expandableExpandableController1.expanded = true;
                                                                  _model.selecteddesigncolor = null;
                                                                  _model.selectedchaindesign = null;
                                                                  initialMetalVal = 'Select Metal';
                                                                  FFAppState().selectedSizeSystem = null;
                                                                  FFAppState().selectedRingSize = null;
                                                                  print('_model.choiceChipsValue1: ${_model.choiceChipsValue1}');
                                                                  print('_model.choiceChipsValue2: ${_model.choiceChipsValue2}');
                                                                });
                                                              },
                                                              selectedChipStyle: ChipStyle(
                                                                  backgroundColor: Color(0x1A740074),
                                                              ...
                                                              controller: _model.choiceChipsValueController2 ??= FormFieldController<List<String>>(['Pendent']),
                                                              wrapped: true,
                                                            ),
                                                          ],
                                                        ),
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return MetalDropdown(
                                                      ...
                                                      onChanged: (val) async {
                                                        // Find the ID for the selected metal
                                                        final selectedMetal = metalData.firstWhere((metal) => metal['name'] == val);
                                                        _selectedMetalId = selectedMetal['id'];
                                                        ...
                                                        if (_selectedMetalId != null) {
                                                          ...
                                                          final metalResponse = getJsonField(response, r'''$.data''', true) ?? [];

                                                          noDesignsAvailable = metalResponse;
                                                          ...
                                                          print('Metal Request Body 23: ${jsonEncode(requestBody)}');
                                                      ...
                                                      children: [
                                                        ...
                                                        TextSpan(
                                                          text: valueOrDefault<String>(
                                                            !(OtherProductsDetailsCall.productRingData(
                                                              containerOtherProductsDetailsResponse?.jsonBody,
                                                            ) != null && (OtherProductsDetailsCall.productRingData(
                                                                  containerOtherProductsDetailsResponse?.jsonBody,
                                                                ))!.isNotEmpty)
                                                                ? _model.choiceChipsValue1
                                                                : _model.choiceChipsValue2,
                                                  ...
                                                  expanded: Builder(
                                                    builder: (context) {
                                                      if ((_model.choiceChipsValue2 ==
                                                          'Pendent') || (_model.choiceChipsValue1 == 'Pendent')) {
                                                        return Builder(
                                                          builder: (context) {
                                                            final selectDesgn = OtherProductsDetailsCall.pendentgroup(
                                                                  containerOtherProductsDetailsResponse?.jsonBody,
                                                                ...
                                                                children: List.generate(selectDesgn.length, (selectDesgnIndex) {
                                                                      ...
                                                                      return InkWell(
                                                                        ...
                                                                        child: Container(
                                                                          ...
                                                                          height: 222,
                                                                          decoration: BoxDecoration(
                                                                            color: _model.selectedpendentdesign == selectDesgnIndex
                                                                                ? Color(0x26740074)
                                                                                : FlutterFlowTheme.of(context).secondaryBackground,
                                                                            borderRadius: BorderRadius.circular(5),
                                                                            border: Border.all(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(),
                                                                                  child: AutoSizeText(getJsonField(
                                                                                    selectDesgnItem, r'''$.name''',).toString(),
                                                                                    maxLines: 2,
                                                                                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: 'Montserrat',
                                                                                      fontSize: 14,
                                                        ...
                                                        return Builder(
                                                          builder: (context) {
                                                            ...
                                                            if (selectBraceletDesign.isEmpty) {
                                                              return Center(
                                                                child: Padding(
                                  ...
                                  if (_selectedMetalId != null && _selectedMetalId!.isNotEmpty && widget.firstLevelName != 'Rudraksha')
                                    Divider(
                                      height: 5,
                                      thickness: 1.5,
                                      color: Color(0xFFE7E7E8),
                                  ...
                                  if (_selectedMetalId != null && _selectedMetalId!.isNotEmpty && noDesignsAvailable == null)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(16, 0, 16, 8),
                                      child: Container(
                                        //decoration: BoxDecoration(),
                                        child: Column(
                                          ...
                                          children: [
                                              ...
                                              child: ExpandableNotifier(
                                                ...
                                                child: ExpandablePanel(
                                                  header: RichText(
                                                    ...
                                                    text: TextSpan(
                                                      children: [
                                                        ...
                                                        TextSpan(
                                                          text: valueOrDefault<String>(!(OtherProductsDetailsCall
                                                              .productRingData(
                                                            containerOtherProductsDetailsResponse?.jsonBody,) !=
                                                              null &&
                                                              (OtherProductsDetailsCall.productRingData(
                                                  ...
                                                  expanded: Builder(
                                                    builder: (context) {
                                                      if ((_model.choiceChipsValue2 == 'Bracelet') || (_model.choiceChipsValue1 == 'Bracelet') ||
                                                          (_model.choiceChipsValue2 == 'Pendent') || (_model.choiceChipsValue1 == 'Pendent') ||
                                                          (_model.choiceChipsValue2 == 'Ring')) {
                                                        return FutureBuilder<ApiCallResponse>(
                                                          future: metalDependantDesign.call(
                                                              hosturl: FFAppConstants.sanityurl,
                                            ...
                                            SizedBox(height: 4),
                                            if(_model.selecteddesigncolor != null && _model.choiceChipsValue2 != 'Pendent')
                                              Divider(
                                                height: 2,
                                                thickness: 1,
                                                color: Color(0xFFE7E7E8),
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                child: MetalDropdown(
                                                                  items: _model.choiceChipsValue2 == 'Ring'
                                                                      ? ringsizesystem
                                                                      : wristsize,
                                                          ...
                                                          // Conditionally display ring size based on selected system
                                                          if (FFAppState().selectedSizeSystem != null && FFAppState().selectedSizeSystem != 'Later / Don\'t Know'
                                                              && _model.choiceChipsValue2 != 'Bracelet')
                                                            Padding(
                                                              padding: EdgeInsetsDirectional.fromSTEB(0, 8, 0, 0),
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  SizedBox(width: 10),
                                                                  if (FFAppState().selectedSizeSystem == 'Indian Ring Size System')
                                                                    Expanded(
                                                                      child: KeyedSubtree(
                                                                        key: ValueKey(FFAppState().selectedSizeSystem),
                                                                        child: MetalDropdown(
                                                                          items: List.generate(indianarray.length, (index) => indianarray[index].toString()),
                                                                          initialValue: 'Select Ring Size',
                                                                          selectedValue: FFAppState().selectedRingSize, // Pass the current selected ring size
