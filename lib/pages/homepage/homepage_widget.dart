...
class _HomepageWidgetState extends State<HomepageWidget> {
  ...
  Future<void> _getCountryCodeFromLocation(Position position) async {
    ...
    if (placemarks.isNotEmpty) {
      String? countryCode =
          placemarks.first.isoCountryCode; // Get country code like 'IN' or 'US'
  ...
  Future<void> _setCurrencyForCountry(String countryCode) async {
    ...
    try {
      final currencyResponse =
          await CurrencyCall.call(sanityurl: FFAppConstants.sanityurl);
      ...
      if (currencyResponse != null) {
        ...
        final conversionRate = functions.currencyRateByName(
          getJsonField(
              currencyResponse.jsonBody, r'''$.currency_data''', true)!,
          currency,
        );
  ...
  Future<void> makeApiCall() async {
    ...
    try {
      ...
      if (customerDetailsResult.succeeded == false) {
        throw Exception(
            "customerDetailsResult ${customerDetailsResult.exceptionMessage}");
      }

      var bannerResult =
          await Bannercall.call(sanityurl: FFAppConstants.sanityurl);
      if (bannerResult.succeeded == false) {
        throw Exception("bannerResult ${bannerResult.exceptionMessage}");
      }
      print("Banner API succeeded");

      var exploreCategoryResult = await ExploreCategoryListCall.call(
          sanityurl: FFAppConstants.sanityurl);
      if (exploreCategoryResult.succeeded == false) {
        throw Exception(
            "exploreCategoryResult ${exploreCategoryResult.exceptionMessage}");
      }
      ...
      if (exploreProductsResult.succeeded == false) {
        throw Exception(
            "exploreProductsResult ${exploreProductsResult.exceptionMessage}");
      }

      var homeBlogResult =
          await HomeBlogCall.call(sanityurl: FFAppConstants.sanityurl);
      ...
      if (notificationsListResult.succeeded == false) {
        throw Exception(
            "notificationsListResult ${notificationsListResult.exceptionMessage}");
      }
                                                                  ...
                                                                  fadeOutDuration:
                                                                      const Duration(
                                                                          milliseconds:
                                                                              500),
                                                                  imageUrl:
                                                                      'https://s3.amazonaws.com/RudraCentre/CategoryThumbnail/Rudraksha/rudraksha-1-mukhi-21-mukhi-thumb.jpg',
                                                                  width: 50,
                                                                  height: 50,
                                                                  fit: BoxFit
                                                                      .cover,
                                                                  ...
                                                                  fadeOutDuration:
                                                                      const Duration(
                                                                          milliseconds:
                                                                              500),
                                                                  imageUrl:
                                                                      'https://s3.amazonaws.com/RudraCentre/CategoryThumbnail/Gemstone/Natural-Loose-Gemstones-A.jpg',
                                                                  width: 50,
                                                                  height: 50,
                                                                  fit: BoxFit
                                                                      .cover,
                                                                  ...
                                                                  fadeOutDuration:
                                                                      const Duration(
                                                                          milliseconds:
                                                                              500),
                                                                  imageUrl:
                                                                      'https://s3.amazonaws.com/RudraCentre/CategoryThumbnail/Yantra/yantras.jpg',
                                                                  width: 50,
                                                                  height: 50,
                                                                  fit: BoxFit
                                                                      .cover,
                                                                  ...
                                                                  fadeOutDuration:
                                                                      const Duration(
                                                                          milliseconds:
                                                                              500),
                                                                  imageUrl:
                                                                      'https://s3.amazonaws.com/RudraCentre/CategoryThumbnail/Other_Products/Brass-Idols_thumb.jpg',
                                                                  width: 50,
                                                                  height: 50,
                                                                  fit: BoxFit
                                                                      .cover,
                                                                  ...
                                                                  fadeOutDuration:
                                                                      const Duration(
                                                                          milliseconds:
                                                                              500),
                                                                  imageUrl:
                                                                      'https://s3.amazonaws.com/RudraCentre/CategoryThumbnail/Other_Products/Pyramid_thumb.jpg',
                                                                  width: 50,
                                                                  height: 50,
                                                                  fit: BoxFit
                                                                      .cover,
                                                                  ...
                                                                  fadeOutDuration:
                                                                      const Duration(
                                                                          milliseconds:
                                                                              500),
                                                                  imageUrl:
                                                                      'https://s3.amazonaws.com/RudraCentre/CategoryThumbnail/Other_Products/Mangalsutra_thumb.jpg',
                                                                  width: 50,
                                                                  height: 50,
                                                                  fit: BoxFit
                                                                      .cover,
                                                                  ...
                                                                  fadeOutDuration:
                                                                      const Duration(
                                                                          milliseconds:
                                                                              500),
                                                                  imageUrl:
                                                                      'https://s3.amazonaws.com/RudraCentre/CategoryThumbnail/Puja/1---Maha-Pujas_88533.jpg',
                                                                  width: 50,
                                                                  height: 50,
                                                                  fit: BoxFit
                                                                      .cover,
                                  ...
                                  Container(
                                    ...
                                    child: Builder(builder: (_) {
                                      if (!expandableListenerRegistered) {
                                        expandableListenerRegistered = true;
                                        _model
                                            .consulatatoinexpandableExpandableController
                                            .addListener(
                                          () async {
                                            _model.textColor =
                                                !_model.textColor;
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('App Version: 1.0.20',
                            style: TextStyle(
                                color:
                                    FlutterFlowTheme.of(context).productName)),
                      ),
                      Builder(
                        builder: (context) {
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return CustomDropdown(
                                            ...
                                            onChanged: (val) async {
                                              ...
                                              setState(() {
                                                print(
                                                    'Selected Currency Name: ${FFAppState().currencyName}');
                                                print(
                                                    'Selected Currency Rate: ${FFAppState().currencyRate}');
                                              });
                                            },
                                          );
                                        },
                                              ...
                                              builder: (context) {
                                                final locale =
                                                    Localizations.localeOf(
                                                        context);
                                                final countryCode = locale
                                                        .countryCode ??
                                                    'IN'; // Default to 'IN' if countryCode is null

                                                // Determine initial currency based on country code
                                                String initialCurrency =
                                                    currencyData!.firstWhere(
                                                  (item) =>
                                                      item['currency_type']
                                                          .toString()
                                                          .contains(
                            ...
                            sanityurl: FFAppConstants.sanityurl,
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final carouselExploreCategoryListResponse =
                                      snapshot.data!;
                                  final encryptedApiResponse =
                                      carouselExploreCategoryListResponse
                                          .bodyText;
                                  print(
                                      "encryptedApiResponse errtr:$encryptedApiResponse");
                                  print(
                                      "carouselExploreCategoryListResponse errtr:$carouselExploreCategoryListResponse");
                                ...
                                final List<dynamic> Bannercall = bannerData['data'];*/
                                      ...
                                      return CarouselSlider.builder(
                                        ...
                                        itemBuilder:
                                            (context, testimonialsIndex, _) {
                                          final BannerItem =
                                              Bannercall[testimonialsIndex];
                                          return Padding(
                                            padding: const EdgeInsetsDirectional
                                                .fromSTEB(0, 10, 0, 10),
                                            child: Material(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  final bannerMainProd =
                                                      getJsonField(BannerItem,
                                                          r'''$.mainprodtype''');
                                                  final bannerLevel =
                                                      getJsonField(BannerItem,
                                                          r'''$.level''');
                                                  ...
                                                  print(
                                                      'Banner Main Product Type: ${bannerMainProd}');
                                                  print(
                                                      'Banner Main Product Type: ${bannerLevel}');
                                              ...
                                              if (await launchUrl(parsedUrl)) {
                                                ...
                                                return;
                                                  ...
                                                  if (bannerMainProd == 0 &&
                                                      bannerLevel == 0) {
                                                    print(
                                                        "Inside if: mainprodtype and level are both 0.");
                                                    ...
                                                    if (url != null &&
                                                      ...
                                                      print(
                                                          "Invalid URL: $slugValue. Navigating to Error404ScreenWidget.");
                                                      Navigator.push(
                                                        context,
                                                        MaterialPageRoute(
                                                            builder: (context) =>
                                                                const Error404ScreenWidget()),
                                                      );
                                                    }
                                                  ...
                                                  setState(() {
                                                    ...
                                                    print(
                                                        "_model.level${_model.level}");
                                                    print(
                                                        "_model.productlist${_model.productlist}");
                                                  });
                                                  print(
                                                      "Slug Value: ${_model.slugvalue}");

                                                  final url = _model.slugvalue;

                                                  print(
                                                      "Slug Value Before Launch: $url");

                                                  if (_model.mainprodtype ==
                                                          5 &&
                                                      _model.level == 1 &&
                                                      _model.slugvalue ==
                                                          "c/rudraksha") {
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            if (getJsonField(productsListItem, r'''$.out_of_stock''').toString() ==
                                                                                'true')
                                                                              Align(
                                                                            ...
                                                                            if (getJsonField(productsListItem, r'''$.reserved''').toString() ==
                                                                                'true')
                                                                              Align(
                                                                                alignment: const AlignmentDirectional(-1, -1),
                                                                                child: Padding(
                                                    ...
                                                    context.pushNamed(
                                                      ...
                                                      queryParameters: {
                                                        ...
                                                        'defaultcategories':
                                                            "Rudraksha",
                                                        'subproductslugvalue':
                                                            "p/rudraksha-kantha-rudraksha-mala",
                                                      },
                                                    );
                                                  } else if (_model
                                                          .choiceChipsValue ==
                                                    ...
                                                    context.pushNamed(
                                                      ...
                                                      queryParameters: {
                                                        ...
                                                        'defaultcategories':
                                                            "Jewellery",
                                                        'subproductslugvalue':
                                                            "p/god-pendants-in-gold-and-silver",
                                                      },
                                                    );
                                                  } else if (_model
                                                          .choiceChipsValue ==
                                                    ...
                                                    context.pushNamed(
                                                      ...
                                                      queryParameters: {
                                                        'productType':
                                                            "OthersMainCategory",
                                                        'productslugvalue':
                                                            "p/fresh-herbs-leaves-flowers-seeds",
                                                        'producttitle':
                                                            "Fresh Puja Flowers, Leaves",
                                                      }.withoutNulls,
                                                    );
                                                  }
                                                },
                                            ...
                                            context.pushNamed(
                                              ...
                                              queryParameters: {
                                                'productType':
                                                    "OthersSubCategory",
                                                'productslugvalue':
                                                    "k/shree-yantra-in-sphatik",
                                                'producttitle':
                                                    "Sphatik Crystal Quartz Shree Yantra",
                                              }.withoutNulls,
                                            );
                                          },
                                          child: Column(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: () async {
                                            print(
                                                "tokenartical $currentAuthenticationToken");
                                            context.pushNamed(
                                              'ArticlesScreen',
                                              extra: <String, dynamic>{
                                                kTransitionInfoKey:
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return CarouselSlider.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          final slugUrl = getJsonField(
                                                  blogsItem, r'''$.slug_url''')
                                              .toString();
                                ...
                                children: [
                                  FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final badgeNotificationsListResponse =
                                          snapshot.data!;
                                  ...
                                  FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      // Get the cart count
                                      final cartCount =
                                          functions.cartBadgeCount(
                                              badgeCartResponse.jsonBody);
