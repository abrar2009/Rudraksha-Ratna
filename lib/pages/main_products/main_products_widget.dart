  ...
  Future<void> _fetchData() async {
    ...
    try {
      if (widget.productType == 'Rudraksha') {
        ...
        newItems =
            YantraProductCall.yantrProductData(response.jsonBody)?.toList() ??
                [];
      }
      ...
      setState(() {
        ...
        print(
            "RudraFFAppState().SelectedSizeGrade : ${FFAppState().SelectedSizeGrade}");
        _isLoading = false;
        if (newItems.isEmpty) {
          _hasMoreData = false;
        }
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          ...
                          offset:
                              Offset(0, 4), // Move shadow downwards by 4 pixels
                ...
                child: Container(
                  ...
                  child: Builder(
                    builder: (context) {
                                                  ...
                                                  child: Padding(
                                                    padding:
                                                        MediaQuery.viewInsetsOf(
                                                            context),
                                                    child:
                                                        FilterComponentWidget(
                                                      productFilterbytype:
                                                          'Gemstone',
                                                      maxprice:
                                                          RudrakshaProductCall
                                                              .constantmaxprice(
                        ...
                        return Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final yantrasYantraProductResponse =
                                  snapshot.data!;
                              final data = YantraProductCall.yantrProductData(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child:
                                                                ...
                                                                imageUrl:
                                                                  ...
                                                                  (widget.productType ==
                                                                              'OthersMainCategory'
                                                                          ? getJsonField(yantrasgridlistItem, r'''$.image''')
                                                                              .toString()
                                                                          : getJsonField(yantrasgridlistItem, r'''$.image''')
                                                                              .toString())
                                                                      .codeUnits
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (currentAuthenticationToken ==
                                                                          ...
                                                                          _model
                                                                              .addToProductid(yantrasgridlistItem.toString());
                                                                          _model.addtoWishlist =
                                                                            ...
                                                                            productid:
                                                                                productId,
                                                                            productType:
                                                                                getJsonField(yantrasgridlistItem, r'''$.mainprodtype'''),
                                                                          );
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    if (getJsonField(productgridlistItem,
                                                                                r'''$.contact_for_price''')
                                                                            .toString() ==
                                                                        'false')
                                                                      RichText(
                      ...
                      } else if (((_model.pujaActionResult?.statusCode ??
                                  200) ==
                              200) &&
                        ...
                        return Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final pujaProductPujaProductResponse =
                                  snapshot.data!;
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment: MainAxisAlignment.start,
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child:
                                                              ...
                                                              imageUrl:
                                                                ...
                                                                (widget.productType ==
                                                                            'OthersMainCategory'
                                                                        ? getJsonField(productgridlistItem,
                                                                                r'''$.image''')
                                                                            .toString()
                                                                        : getJsonField(productgridlistItem,
                                                                                r'''$.image''')
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (currentAuthenticationToken ==
                                                                          ...
                                                                          _model
                                                                              .addToProductid(productgridlistItem.toString());
                                                                          _model.addtoWishlist =
                                                                              await AddToWishlistCall.call(
                                                                            hosturl:
                                                                                FFAppConstants.sanityurl,
                                                                            ...
                                                                            productid:
                                                                                productId,
                                                                            productType:
                                                                                getJsonField(productgridlistItem, r'''$.mainprodtype'''),
                                                                          );
                                                                          if ((_model.addtoWishlist?.succeeded ??
                                                                              true)) {
                                                                            ScaffoldMessenger.of(context).showSnackBar(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final data = PujaProductCall.productlist(
                                    pujaProductPujaProductResponse.jsonBody,
                                  )?.toList() ??
                                  [];
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child:
                                                                ...
                                                                imageUrl:
                                                                  ...
                                                                  (widget.productType ==
                                                                              'OthersMainCategory'
                                                                          ? getJsonField(productgridlistItem, r'''$.image''')
                                                                              .toString()
                                                                          : getJsonField(productgridlistItem, r'''$.image''')
                                                                              .toString())
                                                                      .codeUnits
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final othersProductsOtherProductMainCategoryResponse =
                                  snapshot.data!;
                              final data =
                                  OtherProductMainCategoryCall.yantrProductData(
                                                  ...
                                                  return Stack(
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          print(
                                                              'Slug nownownwo: ${getJsonField(
                                                            yantrasgridlistItem,
                                                            r'''$.slug_value''',
                                                          ).toString()}');
                                                          print(
                                                              'out of stock nownownwo: ${getJsonField(
                                                            yantrasgridlistItem,
                                                            r'''$.out_of_stock''',
                                                          ).toString()}');
                                                          context.pushNamed(
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    if (getJsonField(yantrasgridlistItem,
                                                                                r'''$.contact_for_price''')
                                                                            .toString() ==
                                                                        'false')
                                                                      RichText(
                            ...
                            child: ClipRRect(
                              ...
                              child: SvgPicture.network(
                                ...
                                placeholderBuilder: (context) =>
                                    ShimmerWidget(), // Optional: Add a loading indicator
                              ),
                            ),
                          ),
                        );
