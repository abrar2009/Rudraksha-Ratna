...
class _OtherProductDetailsWidgetState extends State<OtherProductDetailsWidget> {
  ...
  Future<void> fetchCartData() async {
    ...
    try {
      ...
      if (cartItem != null) {
        String? newPreSelectedVariation =
          ...
          children: [
            ...
            FutureBuilder<ApiCallResponse>(
              ...
              builder: (context, snapshot) {
                ...
                print(
                    "otherproductvariantdata: ${OtherProductsDetailsCall.productvariantdataimageurlpath(
                  containerOtherProductsDetailsResponse?.jsonBody,
                )}");
                print(
                    "otherproductimageurlpath: ${OtherProductsDetailsCall.otherproductimageurlpath(
                  containerOtherProductsDetailsResponse?.jsonBody,
                )}");
                print(
                    "otherproductname: ${OtherProductsDetailsCall.otherproductname(
                  containerOtherProductsDetailsResponse?.jsonBody,
                )}");
                print(
                    "otherproductnamecotherproductcode: ${OtherProductsDetailsCall.cotherproductcode(
                  containerOtherProductsDetailsResponse?.jsonBody,
                )}");
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          ...
                                          _scrollController.animateTo(
                                            _OtherProductDetailsWidgetratingKey
                                                .currentContext!
                                                .findRenderObject()!
                                                .getTransformTo(null)
                                                .getTranslation()
                                          ...
                                          child: Row(
                                            ...
                                            children: List.generate(
                                              ...
                                              final selectVariationItem =
                                                  selectVariation[
                                                      selectVariationIndex];
                                              final variantName = getJsonField(
                                                      selectVariationItem,
                                                      r'''$.variant_name''')
                                                  .toString();

                                              final isSelected = variantName ==
                                                  (_model.selectedvariation ??
                                                      preSelectedVariation);
                                                ...
                                                onTap: () async {
                                                  setState(() {
                                                    ...
                                                    _model.selectedVariatoinindex =
                                                        selectVariationIndex;
                                                    preSelectedVariation =
                                                        variantName; // Update the preSelectedVariation to the newly selected value
                                                  });
                                                },
                                                child: Container(
                                                  width: 224,
                                            ...
                                            children: [
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  print(
                                                      "Otherreviewcustomerstarrating:${OtherProductsDetailsCall.Otherreviewcustomerstarrating(
                                                    containerOtherProductsDetailsResponse
                                                        ?.jsonBody,
                                                  )}");
                                                  await showModalBottomSheet(
                              ...
                              if ((_model.apiResultj7i?.succeeded ?? true)) {
                                ...
                                if ((_model.apiResultj7i?.succeeded ?? true)) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        (_model.apiResultj7i?.statusCode ?? 200)
                                            .toString(),
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .containerFillColor,
                                        ...
                                        if (_model.selectedvariation == null &&
                                          ...
                                          _model.selectedvariation =
                                              getJsonField(selectVariation[0],
                                                  ...
                                                  .toString();
                                          _model.selectedVariatoinindex =
                                              0; // Set index for the first variation
                                        }
