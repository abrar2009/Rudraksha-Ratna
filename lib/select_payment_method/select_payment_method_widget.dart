                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if(FFAppState().couponCodeList.isNotEmpty)
                                  InkWell(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  /*dynamic responseData = getJsonField(
                                      stackCartResponse.jsonBody,
                                      r'''$.data[:]''');
                                  ...
                                  if (responseData != null) {
                                    if (responseData is List) {
                                      ...
                                      print(
                                          'Invalid data format in Cart API Response');
                                  ...
                                  if (FFAppState().buynow==true) {
                                    responseData = getJsonField(columnBuyNowResponse.jsonBody, r'''$.data[:]''');
                                  } else {
                                    responseData = getJsonField(stackCartResponse.jsonBody, r'''$.data[:]''');
                                  }
                                  ...
                                  print(
                                      'Delivery Address ID: ${widget.addressId}');
                                  print(
                                      'Billing Address ID: ${widget.addressId}');
                                  print(
                                      'Products: ${jsonEncode(products.map((p) => p.toJson()).toList())}');
                                  ...
                                  if (apiResponse != null &&
                                    ...
                                    print(
                                        'Cart Amount: ${FFAppState().cartAmount}');
                                    //setState(() {});
