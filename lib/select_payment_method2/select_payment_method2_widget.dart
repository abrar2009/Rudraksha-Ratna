...
class _SelectPaymentMethod2WidgetState extends State<SelectPaymentMethod2Widget> {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    var requestBody = {
      ...
      'amount': FFAppState().cartAmount.toInt(),
    ...
    try {
      ...
      // Handle any errors
      print('Error calling OrderPaymentStatusCall: $e');
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text("Failed to update payment status due to an error."),
      ));
    }
  }
  ...
  void _openCheckout() async {
    ...
    var amountInPaise = ((FFAppState().cartAmount) * 100).toInt();
    var orderOptions = {
